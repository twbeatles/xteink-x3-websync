...
a = Analysis(
    ...
    hiddenimports=[
        ...
        'websync.scrapers.youtube', 'websync.scrapers.substack', 'websync.scrapers.soonsal',
        'websync.scrapers.moneyletter', 'websync.scrapers.newsletter_base',
        ...
        'websync.gui.widgets', 'websync.gui.bottom_bar',
        'websync.gui.tab_sync', 'websync.gui.tab_calibre', 'websync.gui.tab_history',
        'websync.gui.tab_settings', 'websync.gui.tab_device_files',
        ...
        'websync.pipeline.sync_pipeline', 'websync.pipeline.preview', 'websync.pipeline.selected_sync',
        'websync.pipeline.article_keys', 'websync.pipeline.log_util',
        'websync.epub.css', 'websync.epub.cover', 'websync.epub.sanitize',
        ...
        'websync.servers.web_dashboard', 'websync.servers.opds',
    ],
